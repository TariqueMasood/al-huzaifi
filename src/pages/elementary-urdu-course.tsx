        ...
        <Content>
          <CourseDiscription>
            ...
            <p>
              ...
              and foundational grammar. By the end of this course, students will
              have gained a fundamental understanding of reading, writing,
              listening, and speaking in Urdu. They will be able to form simple
              sentences, engage in basic conversations, and write basic texts
              using the Urdu script.
            </p>

            <h5>Levels and Duration: </h5>
            <p>
              The Elementary Urdu Course consists of four levels, each requiring
              40 hours of study. The course is structured to progressively
              develop students' proficiency in the language through immersive
              reading, writing, speaking, and listening exercises.
            </p>
            <br />
            <ol>
              <li>
            ...
            <ol>
              ...
              <li>
                <strong>Prepare for Intermediate Urdu Studies:</strong> -Acquire
                the necessary skills to advance to the Intermediate Urdu Course,
                with a solid foundation in vocabulary, grammar, reading,
                writing, and conversational abilities.
              </li>
            </ol>
            ...
            <ol>
              <li>
                <strong>Beginners with No Prior Knowledge:</strong> Individuals
                who are completely new to the Urdu language and wish to learn to
                read, write, and speak Urdu from the ground up.
              </li>
              <li>
                <strong>Learners Preparing for Further Urdu Studies:</strong>{" "}
                Students who plan to continue their Urdu language education and
                want to establish a strong foundation in grammar and
                communication.
              </li>
              <li>
                <strong>Students of Islamic Studies:</strong> Learners who want
                to enhance their understanding of Islamic texts written in Urdu,
                such as religious books and literature.
              </li>
              <li>
            ...
            <p>
              ...
              equipped with essential reading, writing, and speaking skills that
              enable them to understand and use basic Urdu in everyday
