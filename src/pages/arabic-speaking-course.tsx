      ...
      <Container>
        ...
        <Content>
          <CourseDiscription>
            ...
            <p>
              The Arabic Speaking Course is divided into six levels (A1, A2, B1,
              B2, C1, C2), each requiring 45 hours of study. The course is
            ...
            <p>
              ...
              and phrases for more common situations such as shopping, ordering
              food, and describing daily activities. This level focuses on
              improving listening comprehension and responding appropriately in
              dialogues.
            </p>
            ...
            <p>
              ...
              discussing past experiences, hobbies, preferences, etc. Emphasis
              will be placed on building fluency and using more varied sentence
            ...
            <p>
              ...
              personal experiences. Students will practice handling spontaneous
              conversations and responding naturally.
            </p>
            <h5>- C1 (Advanced) </h5>
            <ContentSubTitle>Duration: 45 hours-</ContentSubTitle>
            <p>
            ...
            <p>
              ...
              will engage in nuanced conversations, using idiomatic expressions
              and advanced vocabulary. They will be able to discuss abstract
            ...
            <p>
              ...
              from everyday interactions to more complex discussions. This
              course will equip learners with the fluency and pronunciation
              skills needed to engage in smooth, natural conversations with
              native speakers. As they progress through the levels, students
              will become more adept at expressing their thoughts, opinions, and
              ideas clearly and persuasively. The course will also enhance their
              ability to listen and respond appropriately in real-life
              situations, making it easier for them to navigate both casual and
              formal conversations in Arabic-speaking environments. Ultimately,
              this course will open doors for learners to thrive in social,
              academic, and professional settings where Arabic communication is
              essential.
            </p>
          </CourseDiscription>
          <CourseDetail>
