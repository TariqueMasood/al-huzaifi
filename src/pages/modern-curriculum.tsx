        ...
        <Content>
          <CourseDiscription>
            ...
            <p>
              ...
              designed to provide students with a deep understanding of Islamic
              sciences, while also equipping them with the research, analytical,
              and communication skills needed to address current social,
              ethical, and intellectual challenges. With a balanced focus on
              tradition and modernity, the program aims to prepare scholars who
              can effectively engage with both the classical heritage and
              contemporary issues, offering insights and guidance to their
              communities.
            </p>
            <h5>Course Content:</h5>
            <p>
              The curriculum is divided into 8 semesters, each with a carefully
              planned set of courses that progressively build on the knowledge
              and skills developed in previous semesters.
            </p>
            <CourseList>
              <li>
            ...
            <ol>
              ...
              <li>
                ...
                classical Islamic principles to modern challenges, bridging the
                gap between tradition and modernity.
              </li>
              <li>
                <strong>Leadership and Teaching Skills: </strong>Be prepared to
                lead communities, teach Islamic knowledge, and contribute to
                scholarly discourse.
              </li>
              <li>
            ...
            <ol>
              <li>
                <strong>Seek a Modern Approach to Islamic Studies: </strong>Want
                a structured academic framework that integrates traditional
            ...
            <p>
              ...
              offers an enriching and transformative educational experience. The
              program equips students with the knowledge and skills needed to
              become well-rounded scholars capable of navigating both classical
              and modern Islamic thoughts, preparing them to lead their
              communities with wisdom and insight.
            </p>
          </CourseDiscription>
          <CourseDetail>
            <h5>
