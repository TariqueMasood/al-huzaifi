      ...
      <Container>
        ...
        <Content>
          <CourseDiscription>
            ...
            <p>
              The Foundation Arabic Course is designed to provide students with
              a comprehensive introduction to the Arabic language, covering
              grammar from A1 to C2, alongside reading, writing, listening, and
              speaking. This course is ideal for beginners and intermediate
              learners who wish to build a solid foundation in both classical
              and modern Arabic. By the end of the course, students will be able
              to engage in everyday conversations, read and understand Arabic
              texts, and write simple to complex sentences with confidence.
            </p>
            ...
            <p>
              ...
              including a thorough understanding of Arabic grammar from beginner
              to advanced levels.
            </p>
            ...
            <p>
              Duration: 80 hours Focuses on the Arabic alphabet, pronunciation,
              and basic vocabulary. Students will learn to introduce themselves,
              ask simple questions, and form basic sentences. Emphasis is placed
              on building reading, writing, and basic speaking skills while
              introducing foundational grammar concepts.
            </p>
            ...
            <p>
              ...
              through guided dialogues, with grammar being integrated into these
              practices.
            </p>
            ...
            <p>
              ...
              Grammar lessons will continue, building on what was learned in A1
              and A2.
            </p>
            ...
            <p>
              ...
              and improve their fluency. Grammar lessons will cover more
              advanced structures such as relative clauses and conditional
              sentences. Students will practice reading intermediate-level texts
              and writing coherent essays, integrating their advanced grammar
              knowledge.
            </p>
            <h5>- C1 (Advanced) </h5>
            <ContentSubTitle>Duration: 80 hours-</ContentSubTitle>
            <p>
              ...
              comprehension of complex texts. Students will write detailed
              essays and reports, engaging in discussions on abstract topics
              such as culture, history, and politics. Speaking practice will
              emphasize professional and formal language use, while advanced
              grammar will be applied consistently.
            </p>
            <h5>- C2 (Proficiency) </h5>
            <ContentSubTitle>Duration: 80 hours-</ContentSubTitle>
            <p>
              The final level prepares students to engage in fluent, near-native
              conversations and discussions. Students will read and analyze
              advanced literary and technical texts, and their writing will
              focus on clear, precise, and articulate communication. This level
              includes practice in formal debates and presentations, with a
              strong focus on mastering complex grammar and syntax.
            </p>
            ...
            <ol>
              ...
              <li>
                ...
                contexts, and apply this knowledge to comprehend a wide range of
                written texts.
              </li>
              <li>
              ...
              <li>
                ...
                courses such as the Alimiyat program, with a solid grasp of
            ...
            <p>
              ...
              ability to confidently read and write Arabic, allowing them to
              engage with a variety of texts, from everyday materials to
              classical literature. They will acquire the grammatical knowledge
              and vocabulary necessary to construct accurate sentences and
              express themselves effectively in both written and spoken Arabic.
              As their speaking skills develop, they will be able to engage in
              meaningful conversations with native speakers, discussing a wide
              range of topics. The course also fosters a deeper understanding
              and appreciation of Arabic culture, preparing students for further
              studies or professional opportunities requiring fluency in the
              language.
            </p>
          </CourseDiscription>
          <CourseDetail>
