        ...
        <Content>
          <CourseDiscription>
            ...
            <p>
              ...
              syntax (Nahw) and morphology (Sarf). These two essential branches
              of Arabic linguistics form the foundation for mastering the Arabic
              language, especially in understanding classical texts such as the
              Quran, Hadith, and other scholarly works. The course aims to
              enable students to analyze sentence structures, comprehend word
              formations, and apply grammatical rules accurately.
            </p>
            ...
            <p>
              ...
              is divided into two main components, syntax (Nahw) and morphology
              (Sarf), and covers the following topics:
            </p>

            <h5>1. Introduction to syntax (Nahw) and morphology (Sarf): </h5>
            <p>
              An overview of the importance of syntax (Nahw) and morphology
              (Sarf) in the Arabic language and their role in understanding the
              Quran, Hadith, and classical literature.
            </p>
            ...
            <p>
              ...
              Ismiyya) and verbal (Jumla Fi'liyya), including their components
              and usage.
            </p>
            <h5>4. Grammatical Cases (I'rab): </h5>
            <p>
              Exploring the grammatical cases (nominative, accusative, and
              genitive) and how they affect the endings of nouns, pronouns, and
              adjectives.
            </p>
            ...
            <p>
              ...
              / future (Mudari'), and command (Amr) tenses, as well as the
            ...
            <p>
              Practical exercises to apply the rules of syntax (Nahw) in reading
              and analyzing Arabic sentences, with a focus on the Quran and
              classical texts.
            </p>
            ...
            <p>
              Hands-on exercises in identifying root letters, conjugating verbs,
              and forming nouns from various roots, with a focus on classical
              texts and Quranic verses.
            </p>
            ...
            <ol>
              <li>
                ...
                sentence structures, including subject-predicate relationships,
                grammatical cases, and verb conjugation.
              </li>
              <li>
              ...
              <li>
                ...
                Hadith, and classical texts by understanding the grammatical and
              ...
              <li>
                ...
                Hadith, Fiqh, and Arabic literature, by mastering the linguistic
                foundations of syntax (Nahw) and Morphology (Sarf).
              </li>
            </ol>
            ...
            <p>
              The Arabic Grammar Course at Al-Huzaifi Academy provides students
              with a strong foundation in the key linguistic elements of Arabic.
              With this knowledge, students will be able to engage with complex
              texts, including the Quran, Hadith, and scholarly works, with
              greater accuracy and understanding. This course is an essential
              stepping stone for anyone looking to deepen their expertise in the
              Arabic language and pursue advanced studies in Islamic sciences.
            </p>
          </CourseDiscription>
          <CourseDetail>
            <h5>
            ...
            <h5>
              Entry Requirement: <span>Basic Knowledge of Arabic Language</span>
            </h5>
            <h5>
