        ...
        <Content>
          <CourseDiscription>
            ...
            <p>
              ...
              aspiring scholars (Ulama) with the depth of knowledge and
              analytical skills required to interpret classical texts and apply
              Islamic rulings in modern contexts. Rooted in centuries of Islamic
              scholarship, this curriculum emphasizes a strong foundation in
              theology, law, and language, fostering spiritual and intellectual
              growth. Graduates of this program are well-prepared to serve as
              leaders, teachers, and scholars within their communities, guiding
              others with wisdom and integrity.
            </p>
            ...
            <p>
              ...
              progressively from beginner to advanced levels over the course of
              the program:
            </p>
            <ol>
              <li>
                ...
                enable them to access and comprehend primary Islamic sources in
                their original language.
              </li>
              <li>
                <strong>Beliefs of Islam (Aqidah): </strong>This subject covers
                the core tenets of Islamic faith, exploring the beliefs
              ...
              <li>
                ...
                delving into the linguistic, historical, and contextual aspects
                of the Quranic verses. This subject emphasizes a detailed
                understanding of the divine message and its application in daily
                life.
              </li>
              <li>
              ...
              <li>
                ...
                Muhammad (ﷺ) to the modern era. Students will gain insights into
                how Islamic thought and practices evolved over time.
              </li>
              <li>
                <strong>Final Year Specialization: </strong>In the fifth and
                final year, students focus on the intensive study of the Sihah
                Sitta (the six major books of Hadith) and other important works:
                <UnOrderList>
                  <li>- Sahih Bukhari</li>
                  <li>- Sahih Muslim</li>
                ...
                teachings of the Prophet Muhammad (ﷺ) with precision and depth.
              </li>
            </ol>
            ...
            <ol>
              ...
              <li>
                <strong>Contribute to Islamic Scholarship: </strong>Be equipped
                to contribute to ongoing Islamic discourse, engaging in research
                and scholarly debate on critical issues facing the Muslim world.
              </li>
            </ol>
