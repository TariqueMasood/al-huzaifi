      ...
      <Wrapper>
        <Container>
          ...
          <CourseDiscription>
            ...
            <p>
              Our <strong>Darul Ifta</strong> department caters to a wide range
              of queries and legal matters, providing Muslims with a
              comprehensive resource for Islamic guidance. We address:
            </p>
            <p>
            ...
            <p>
              ...
              donation, end-of-life care, and bioethical concerns such as
              in-vitro fertilization (IVF), cloning, and genetic research. We
              bridge the gap between Islamic ethics and modern medical
              challenges.
            </p>
            <p>
              <strong>- Modern Technological Concerns: </strong>In an era of
              rapid technological advancement, we provide fatwas on contemporary
              issues such as artificial intelligence, cryptocurrency, data
              privacy, and social media use, helping Muslims align their digital
              lives with Islamic principles.
            </p>
            <br />
            <h5>Our Scholars: Expertise and Dedication:</h5>
            <p>
              The <strong>Darul Ifta</strong> team is composed of esteemed
              Muftis and Islamic scholars with deep expertise in various fields
              of Islamic jurisprudence (fiqh). Each member of our team has
              undergone extensive education in both traditional Islamic sciences
              and contemporary fields, allowing them to address complex
              questions with wisdom and balance. Our scholars are trained in the
              classical schools of thought - Hanafi, Maliki, Shafi'i, and
              Hanbali - and are equipped to deliver rulings that reflect the
              diversity within Islamic jurisprudence.
            </p>
            <p>
              ...
              questioner, ensuring that their fatwas are practical and
              applicable in real-life situations. Our goal is to uphold the
              integrity of Islamic law while providing flexible and
              compassionate solutions to today's challenges.
            </p>
            <br />
            <h5>Darul Ifta Question Submission Form</h5>
            <p>
              If you have a question regarding Islamic rulings or require
              guidance on a specific matter, please complete the form below. By
              providing clear and detailed information, you allow our scholars
              to address your question accurately and effectively.
            </p>
